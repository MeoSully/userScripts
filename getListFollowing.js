...
setTimeout(function() {clearInterval(sdown);document.write(Array.from(document.querySelectorAll("._2g7d5.notranslate._o5iw8")).forEach((id) => {return id.href;}).join("<br>"));}, people);
